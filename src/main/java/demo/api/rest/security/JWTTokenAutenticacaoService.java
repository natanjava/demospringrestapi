package demo.api.rest.security;
...
import demo.api.rest.ApplicationContextLoad;
...
public class JWTTokenAutenticacaoService {
	...
	/* Tem de validade do Token (em milisegundos) -> 2 dias */
	...
	public void addAuthentication(HttpServletResponse response, String username) throws IOException {
		...
		/* liberando resposta para diferentes clientes web*/
		...
		try {
			...
			if (token != null) { 
				...
				String user = Jwts.parser().
								setSigningKey(SECRET) /* Bearer 87878we8we787w8e78w78e78w7e87w */
								.parseClaimsJws(tokenLimpo) /* 87878we8we787w8e78w78e78w7e87w */
								.getBody()
								.getSubject(); /* descompacta tudo e retorna so usuario, p.ex: João Silva */
